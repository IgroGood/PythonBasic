...
print(road.calculating_the_mass_of_asphalt())

# 3
person_igor = Position('Alex', 'Su', 'programmer', {"wage": 15000, "bonus": 4200})
print(person_igor.get_full_name())
print(person_igor.get_total_income())
person_vova = Position('Vova', 'Su', 'programmer', {"wage": 14000, "bonus": 500})
print(person_vova.get_full_name())
print(person_vova.get_total_income())

# 4
townCar = TownCar('red', 'supra 2')
workCar = WorkCar('red', 'supra 1')
policeCar = PoliceCar( 'blue', 'supra 3')
